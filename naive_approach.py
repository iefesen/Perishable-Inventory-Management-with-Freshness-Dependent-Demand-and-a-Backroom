# -*- coding: utf-8 -*-
"""
Created on Wed Oct  2 17:09:05 2024
                ...
                for s in s_range:
                    for lambda_c in lambda_c_range:
                        for P_b in P_b_range:
                            ...
                            naive_policy = np.zeros((I+1, L+1, L+1))
                            naive_policy[:, 0, :] = 1
                            naive_policy[0, :, :] = 1
                            ...
                            stationary_dist = calculate_stationary_distribution(P, naive_policy, I, L)
                                ...
                                for l in range(L+1):
                                    for l_b in range(L+1):
                                        if l >= l_b:
                                            ...
                                            naive_avg_reward += R[i, l, l_b, int(naive_policy[i, l, l_b])] * stationary_dist[i, l, l_b]
                            end_time = time.time()
                            ...
                            results.append({
                                ...
                                "lambda_c": lambda_c,
                                "P_b": P_b,
                                "Naive_avg_rew": naive_avg_reward,
...
df.to_excel("naive_approach2.xlsx", index=False)
