# -*- coding: utf-8 -*-
"""
Created on Tue Oct  1 14:27:07 2024
                ...
                for s in s_range:
                    for lambda_c in lambda_c_range:
                        for P_b in P_b_range:
                            case += 1
                            if K == 240 or K == 260 or K==280 or K == 300:
                                continue
                            ...
                            optimal_time = end_optimal - start_time
                            ...
                            results.append({
                                ...
                                "Time to find the optimal policy": optimal_time,
...
df.to_excel("L_sensitivity.xlsx", index=False)
