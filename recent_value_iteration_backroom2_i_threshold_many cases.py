                    ...
                    for lambda_c in lambda_c_range:
                        for P_b in P_b_range:
                            ...
                            try:
                                ...
                                print(f"Error reshaping steady_state_opt: {e}")
                                continue
...
columns = ['K', 'I', 'L', 'p', 's', 'lambda_c', 'P_b', 'opt_average'] + [f'average_{i_t}' for i_t in range(I + 1)]

results_df = pd.DataFrame(results, columns=columns)
results_df.to_excel('average_rewards_threshold_i_analysis5.xlsx', index=False)
