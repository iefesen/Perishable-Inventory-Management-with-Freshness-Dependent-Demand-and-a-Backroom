# -*- coding: utf-8 -*-
"""
Created on Thu Nov 14 13:32:09 2024
                ...
                for s in s_range:
                    for lambda_c in lambda_c_range:
                        for P_b in P_b_range:
                            ...
                            heuristic_policy_all = np.zeros((L))

                            for l_d in range(0, L):
                                    ...
                                    for l in range(L+1):
                                        for l_b in range(L+1):
                                            if l == 0 or i == 0 or l_b == 0:
                                                ...
                                                if  -K/(l_d + 1) + s*i + p*min(I, lambda_c*l_b/L) - p*min(i, lambda_c*l/L) > 0:
                                                    heuristic_policy[i, l, l_b] = 1
                                ...
                                heuristic_policy_all[l_d] = heuristic_avg_reward          
                            ...
                            results.append({
                                ...
                                "lambda_c": lambda_c,
                                "P_b": P_b,
                                "Heuristic_avg_reward": heuristic_policy_all,
...
df.to_excel("newest_heur_div_l.xlsx", index=False)
