# -*- coding: utf-8 -*-
"""
Created on Fri Nov  8 17:13:20 2024
                ...
                for s in s_range:
                    for lambda_c in lambda_c_range:
                        for P_b in P_b_range:
                                ...
                                for l in range(L+1):
                                    for l_b in range(L+1):
                                        if l == 0 or i == 0 or l_b == 0:
                                            ...
                                            if -K + s*i + p*lambda_c*sum(j/L for j in range(l + 1, l_b + 1)) > 0:
                                                heuristic_policy[i, l, l_b] = 1
                            ...
                            # plot_heuristic_policy(heuristic_policy, L, I)
...
df.to_excel("heuristic_tryout_straigtforward.xlsx", index=False)
